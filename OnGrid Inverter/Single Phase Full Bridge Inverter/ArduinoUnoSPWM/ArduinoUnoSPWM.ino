...
/* Left bridge used for fundamental signal (50 HZ), Right bridge for SPWM (10kHz carrier freq.)
   Look Up table entries = 10kHz/50Hz = 200 entries per cycle
   SPWM cycle = fXTAL/freq. carrier = 16.000.000/10.000 = 1.600 clock. WGM mode 8 is used, so ICR1 = 1.600/2 = 800 clk
   Look up tables for a half cycle (100 entries), max value = 800 (100% duty cycle)is loaded into register ICR1.
*/
